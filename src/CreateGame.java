...
public class CreateGame extends javax.swing.JFrame implements Serializable {
    ArrayList<Game> game_list;
    public CreateGame(ArrayList<Game> game_list) {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(863, 536));
        ...
        jTextArea1.setFont(new java.awt.Font("Helvetica Neue", 1, 13)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Game game = new Game();
        game.setGame(name,description,genre);
        game_list.add(game);
        this.dispose();
