...
public class Dashboard extends javax.swing.JFrame implements Serializable{
    private User user;
    ...
    public Dashboard(Main main,User user, ArrayList<User> user_list, ArrayList<Game> game_list) {
        this.user = user;
        ...
        DashboardMenu menu = new DashboardMenu(user,game_list);
    ...
    private void initComponents() {
        ...
        ReviewsLayout.setHorizontalGroup(
            ...
            .addGroup(ReviewsLayout.createSequentialGroup()
                .addGap(39, 39, 39)
    ...
    private void ProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProfileMouseClicked
        Profile profilemenu = new Profile(user, user_list, game_list);
        jDesktopPane.removeAll();
        jDesktopPane.add(profilemenu).setVisible(true);
    }//GEN-LAST:event_ProfileMouseClicked

    private void ReviewsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReviewsMouseClicked
        MyReviews my_reviews = new MyReviews(user);
        jDesktopPane.removeAll();
        jDesktopPane.add(my_reviews).setVisible(true);
